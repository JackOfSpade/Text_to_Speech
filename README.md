...
# For Developers
Due to security reasons, the API key for Amazon Web Services (AWS) used in the compiled `TextToSpeech.jar` is not included in the source code. You must change the following line in `AmazonPolly.java` before compiling:
